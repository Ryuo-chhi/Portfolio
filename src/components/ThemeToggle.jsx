...
export default function ThemeToggle({ theme, toggleTheme, className = '' }) {
  ...
  return (
    <button
      ...
      style={{
        background: dark
          ? 'linear-gradient(150deg, #1b2a3c, #33475e)'
          : 'linear-gradient(150deg, #bfe2ff, #eaf5ff)',
      }}
    >
      ...
      <span
        ...
        aria-hidden="true"
      >
        <span className="absolute left-2.5 top-2 h-[3px] w-[3px] rounded-full bg-[#fbf8f1]" />
        <span className="absolute left-5 top-5 h-[2px] w-[2px] rounded-full bg-[#fbf8f1] opacity-80" />
        <span className="absolute left-3.5 top-[22px] h-[2px] w-[2px] rounded-full bg-[#fbf8f1] opacity-70" />
      </span>
      ...
      <span
        ...
        aria-hidden="true"
      >
        <span className="block h-[6px] w-3.5 rounded-full bg-[#6d9b86]" />
        <span className="absolute -top-1 right-1 h-[7px] w-[7px] rounded-full bg-[#6d9b86]" />
      </span>
      ...
      >
        ...
        <span
          ...
          style={{ opacity: dark ? 1 : 0 }}
        >
          <span className="absolute left-[6px] top-[5px] h-[5px] w-[5px] rounded-full bg-[#6d8f7c]" />
          <span className="absolute left-[13px] top-[12px] h-[6px] w-[6px] rounded-full bg-[#6d8f7c] opacity-85" />
          <span className="absolute left-[6px] top-[15px] h-[3px] w-[3px] rounded-full bg-[#6d8f7c] opacity-75" />
        </span>
      </span>
    </button>
  )
